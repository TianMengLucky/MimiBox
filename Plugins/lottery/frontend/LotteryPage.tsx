...
import type { LotteryData, LotteryPrize, LotteryScheme } from "./types";

/** 抽奖玩法：幸运转盘 / 老虎机 */
type LotteryMode = "wheel" | "slot";

/** 页面数据读写（index.tsx 里用插件上下文构造后传入） */
type LotteryStore = ReturnType<typeof createLotteryStore>;
...
export default function LotteryPage({ store }: { store: LotteryStore }) {
