...
import { BracketFlow } from "@components/prediction/BracketFlow";
import type { BracketActions } from "@components/prediction/BracketFlow";
import { EntryPool } from "@components/prediction/EntryPool";
import {
  loadPredictionData,
  savePredictionData,
} from "@components/prediction/store";
import {
  MAX_ENTRIES,
  MAX_NODES_PER_ROUND,
  MAX_ROUNDS,
...
export const Route = createFileRoute("/feature/prediction")({
...
function PredictionRoute() {
  ...
  const {
    ...
    load: loadPredictionData,
    save: savePredictionData,
    logLabel: "保存赛事预测数据失败",
    normalize,
