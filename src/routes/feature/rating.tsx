...
import { ImportDialog } from "@components/rating/ImportDialog";
import { RatingCard } from "@components/rating/RatingCard";
import { loadRatingData, saveRatingData } from "@components/rating/store";
import type {
  RatingData,
  RatingScheme,
  RatingSort,
} from "@components/rating/types";
import { MAX_ITEMS } from "@components/rating/types";

export const Route = createFileRoute("/feature/rating")({
