...
import { imageSize } from "@components/whiteboard/image";
import { loadWhiteboardData, saveWhiteboardData } from "@components/whiteboard/store";
import { DEFAULT_ITEM_WIDTH, emptyWhiteboardData } from "@components/whiteboard/types";
import type { BoardItem, WhiteboardData } from "@components/whiteboard/types";

export const Route = createFileRoute("/feature/whiteboard")({
...
function WhiteboardRoute() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      saveWhiteboardData(data).catch((err) => {
